		...
		Pass
         {
			...
			#include "Packages/com.valenvrc.vvrsl/Runtime/Shaders/Shared/VRSL-Defines.cginc" //Property Defines are here
			...
			#include "Packages/com.valenvrc.vvrsl/Runtime/Shaders/MovingLights/VRSL-StandardMover-ProjectionFrag.cginc" //Fragment Shader is here
			#include "Packages/com.valenvrc.vvrsl/Runtime/Shaders/MovingLights/VRSL-StandardMover-Vertex.cginc" //Vertex Shader is here
